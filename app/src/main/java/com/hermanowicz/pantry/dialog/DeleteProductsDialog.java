...
public class DeleteProductsDialog extends AppCompatDialogFragment {
    ...
    private DeleteProductsDialogListener dialogListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setTitle(getString(R.string.MyPantryActivity_delete_products))
                .setNegativeButton(getString(R.string.MyPantryActivity_cancel), (dialog, which) -> {
                })
                .setPositiveButton(getString(R.string.MyPantryActivity_delete_products), (dialog, which) -> {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            dialogListener = (DeleteProductsDialogListener) context;
